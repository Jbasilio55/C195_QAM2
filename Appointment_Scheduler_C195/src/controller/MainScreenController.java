    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            for(Appointment a: allAppointmentsList){
                ...
                ZonedDateTime endET = a.getEnd().atZone(ZoneId.of("UTC")).withZoneSameInstant(localTimeZone);

                // Update the appointment with adjusted start and end times
                a.setStart(startET.toLocalDateTime());
                a.setEnd(endET.toLocalDateTime());
            }
