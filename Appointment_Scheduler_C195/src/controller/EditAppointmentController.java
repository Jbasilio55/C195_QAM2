...
public class EditAppointmentController implements Initializable {
    ...
    void onActionSave(ActionEvent event) throws SQLException, IOException {
        ...
        if(appTitle == null || appDescription == null || appLocation == null || appType == null ||
                startTime == null || endTime == null || customer == null || contact == null || user == null){
        ...
        if(startDate.isAfter(endDate) || endDate.isBefore(startDate) || startTime.isAfter(endTime) || endTime.isBefore(startTime)){
        ...
        if (action.equals("add")) {
            ...
            AppointmentDBAccess.insertAppointment(appTitle, appDescription, appLocation, appType, startUTC, endUTC,
                    customerId, userId, contactId);
        } else if (action.equals("update")) {
            int id = Integer.parseInt(appIdTxt.getText());
            // Update the appointment with UTC start and end times
            AppointmentDBAccess.updateAppointment(id, appTitle, appDescription, appLocation, appType, startUTC, endUTC,
                    customerId, userId, contactId);
        }
        changeWindow(event, "/view/MainScreen.fxml");
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            if(appointment != null){
                ...
                startDatePicker.setValue(easternStartDateTime.toLocalDate());
                startCombo.setValue(easternStartDateTime.toLocalTime());
                endDatePicker.setValue(easternEndDateTime.toLocalDate());
                endCombo.setValue(easternEndDateTime.toLocalTime());
